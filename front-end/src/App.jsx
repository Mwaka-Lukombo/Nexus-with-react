        ...
        {userAuth && 
         ...
         <div
          ...
          <Routes>
            ...
            <Route path='/createForum' element={userAuth ? <CreateForumForm /> : <Navigate to={'/login'} />} />
            <Route path='/forum' element={userAuth ? <ForumDebateArea /> : <Navigate to={'/login'} />} />
