...
export const Header = () => {
  ...
  return (
    ...
    <div ref={sideBarNotifications} className={`hidden transition-all fixed top-0 right-0 w-full md:w-[400px] h-screen bg-white shadow-2xl z-50`}>
      <div className='p-3'>
        <div onClick={handleSideBarNotification} className='w-[40px] h-[40px] bg-[#ccc] hover:bg-[#cccc] rounded-full flex items-center justify-center cursor-pointer'>
          <X />
        </div>
      </div>
      ...
      <div className='my-4 w-full overflow-y-auto'>
           {Array.isArray(notifications) && notifications.map((notification) => (
            <div className='flex items-center justify-around gap-2 w-full p-2 h-[70px] border-t border-b border-[#ccc]'>
             ...
             <div className='flex flex-col justify-center items-center'>
              ...
              <p className='flex items-center justify-center gap-2 text-xs font-bold'>
             ...
             <div>
               <p className='text-xs font-bold'>{notification.from.typeUser}</p>
               <span className='cursor-pointer'><Settings className='size-5' /> </span>
             </div>
           </div>
           ))}
      </div>
      ...
      <div className='px-5 flex items-center justify-end w-full min-h-[70px] border border-[#cccc] rounded-xl mb-5 shadow-md'>
        <div className='flex items-center gap-4'>
          ...
          <div onClick={handleSideBarNotification} className='w-[40px] h-[40px] flex items-center justify-center relative cursor-pointer transition hover:bg-[#ccc] rounded-xl'>
            <Bell size={20} />
