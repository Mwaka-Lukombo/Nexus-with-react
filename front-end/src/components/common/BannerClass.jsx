  ...
  return (
    <div className={`w-full md:h-[200px] flex justify-center md:justify-normal mb-4 shadow-xl ${color ?? "bg-secundary-color/85"} border border-[#ccc] rounded-3xl ${bg && `bg-[${bg}]`}`}>
     ...
     <div className='w-[85%] h-full p-7 px-2 rounded-tr-xl rounded-br-xl text-white'>
      <h2 className='text-2xl font-normal text-center md:text-left'>
        {userAuth?.typeUser === 'teacher' ? "Teach your students with online method" : "Learnig Online"}
      </h2>
      <p className='my-3 text-sm text-justify tracking-[1px] max-w-[700px]'>{`Jean Piaget is the first university put the online and presential leading method 
