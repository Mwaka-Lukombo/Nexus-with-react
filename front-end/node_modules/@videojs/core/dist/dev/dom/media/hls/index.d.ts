...
declare class HlsMediaDelegate extends EventTarget implements Delegate {
  #private;
  get target(): HTMLMediaElement | null;
  get engine(): Hls | null;
  get error(): MediaError$1 | null;
  get src(): string;
  set src(src: string);
...
} & HlsMediaDelegate> & Omit<CustomVideoElement, "prototype">;
declare class HlsCustomMedia extends HlsCustomMedia_base {}
declare const HlsMedia_base: _videojs_utils_types0.Constructor<HTMLVideoElement & MediaProxy & HlsMediaDelegate> & Omit<_videojs_utils_types0.Constructor<HTMLVideoElement & MediaProxy>, "prototype">;
declare class HlsMedia extends HlsMedia_base {}
//#endregion
export { Hls, HlsCustomMedia, HlsMedia, HlsMediaDelegate, PlaybackType, PlaybackTypes, PreloadType, SourceType, SourceTypes };
